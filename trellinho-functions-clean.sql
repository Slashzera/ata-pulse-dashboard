-- FUNCOES TRELLINHO - VERSAO LIMPA SEM COMENTARIOS PROBLEMATICOS
...
BEGIN
    ...
    RETURN result;
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;CREAT
E OR REPLACE FUNCTION move_card_to_list(
    card_uuid UUID,
...
BEGIN
    ...
    RETURN result;
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;C
REATE OR REPLACE FUNCTION manage_card_labels(
    card_uuid UUID,
    label_ids UUID[]
)
RETURNS JSON AS $$
...
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;CR
EATE OR REPLACE FUNCTION get_user_notifications(
