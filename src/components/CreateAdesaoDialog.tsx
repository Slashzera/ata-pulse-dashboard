...
interface CreateAdesaoDialogProps {
  isOpen: boolean;
  onClose: () => void;
}

const CreateAdesaoDialog: React.FC<CreateAdesaoDialogProps> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Preparar dados com tratamento adequado para datas vazias
    const dataToSubmit = {
      ...formData,
      category: 'adesao' as const,
      vencimento: formData.vencimento || undefined // Converte string vazia para undefined
    };
    
    createAtaMutation.mutate(dataToSubmit);
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            ...
            >
              {createAtaMutation.isPending ? 'Salvando...' : 'Criar Adesão'}
            </Button>
          </div>
        </form>
      </DialogContent>
...
export default CreateAdesaoDialog;
