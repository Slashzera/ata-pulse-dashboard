-- Modificação da função create_board_with_type para criar listas padrão específicas
-- Baseado na solicitação para criar automaticamente as listas do processo administrativo
...
-- 2. Recriar função com as listas padrão específicas
...
-- 3. Criar também a versão de sobrecarga para compatibilidade
CREATE OR REPLACE FUNCTION public.create_board_with_type(
